...
nsteps = 15
concretization_intervals = [8,4,3] 
top_data = quad_6D_reach(input_set, nsteps, concretization_intervals)
JLD2.@save "src/examples/extra/data/quad6D_reachability_data_15_top.jld2" top_data
...
JLD2.@save "src/examples/extra/data/quad6D_reachability_data_15_bottom.jld2" bottom_data
